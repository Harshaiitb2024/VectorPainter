...
### Sunflowers
```shell
python strokestyle.py "prompt='A bouquet of roses in a vase. van Gogh style.'" x=stroke target="./assets/sunflowers.jpg" result_path='./workdir/Sunflowers/roses_sunflowers' seed=100
```

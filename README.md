...
```shell
CUDA_VISIBLE_DEVICES=5 python vectorpainter.py x=stroke prompt='A horse is drinking water by the lake. van Gogh style.' target="./assets/starry.jpg" result_path='./workspace/Starry/horse_starry' seed=100
CUDA_VISIBLE_DEVICES=1 python vectorpainter.py "prompt='A photo of Sydney opera house.'" x=stroke target="./assets/starry.jpg" result_path='./workspace/Starry/sydney_starry' seed=100
...
CUDA_VISIBLE_DEVICES=1 python vectorpainter.py x=stroke "prompt='A mountain, with clouds in the sky.'" target="./assets/starry.jpg" result_path='./workspace/Starry/mountain_starry' seed=101
...
```shell
CUDA_VISIBLE_DEVICES=5 python vectorpainter.py "prompt='A brightly colored mushroom growing on a log. van Gogh style.'" x=stroke target="./assets/Field.jpg" result_path='./workspace/Field/mushroom_Field'
...
CUDA_VISIBLE_DEVICES=6 python vectorpainter.py "prompt='A photo of Sydney opera house.'" x=stroke target="./assets/Field.jpg" result_path='./workspace/Field/sydney_Field' seed=100
```
...
CUDA_VISIBLE_DEVICES=2 python vectorpainter.py "prompt='A beach with a cruise ship passing by.'" x=stroke target="./assets/Impression.jpg" result_path='./workspace/impression/beach_impression'
CUDA_VISIBLE_DEVICES=3 python vectorpainter.py "prompt='A panda rowing a boat in a pond.'" x=stroke target="./assets/Impression.jpg" result_path='./workspace/impression/panda_impression'
```
...
```shell
CUDA_VISIBLE_DEVICES=4 python vectorpainter.py "prompt='The Great Pyramid.'" x=stroke target="./assets/majeur.jpg" result_path='./workspace/majeur/pyramid_majeur'
CUDA_VISIBLE_DEVICES=5 python vectorpainter.py "prompt='A Torii Gate.'" x=stroke target="./assets/majeur.jpg" result_path='./workspace/majeur/torii_majeur'
